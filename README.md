...
* **🖥️ High-Resolution VESA Graphics**: Runs natively in **1280x1024** VESA VBE mode with a 24-bit linear framebuffer.
* **✍️ Slick Bold Font Engine**: Implements dynamic upscale character rendering at **12x24** pixel bounds with bold pixel-interpolation to keep text clean, sharp, and readable.
...
![ZenithOS Boot Screen](assets/boot_screen.png)

### 2. Interactive Terminal Shell
![ZenithOS Interactive Shell](assets/shell_terminal.png)
